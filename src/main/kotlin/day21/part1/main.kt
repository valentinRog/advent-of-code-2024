...
fun String.compute(): Int {
    fun dfs(s: String, l: List<Map<Complex, Char>>, i: Int): Int {
        if (i == l.size) return s.length
    ...
    return dfs(this, listOf(numPad, dirPad, dirPad), 0)
}
...
fun main() =
    generateSequence(::readLine)
        ...
        .replace("\r", "")
        .lines()
        .sumOf { it.compute() * it.substring(0..<it.lastIndex).toInt() }
        .let(::println)
